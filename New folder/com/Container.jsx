...
const App = () => {
    return (
      <div class="sm:m-6 space-y-6">
        <div className="light relative bg-skin-fill md:rounded-md max-w-4xl mx-auto space-y-6 md:p-6 py-6 px-3 ">
          <h2 className=" text-skin-base text-center text-4xl font-bold">OnFill</h2>
          <div className="text-skin-muted md:mx-6 bg-skin-on-fill p-3 rounded-md md:p-6">Lorem, ipsum dolor sit amet consectetur  maxime consequuntur consectetur fuga qui deserunt facere dolore, eos rerum sapiente, quod at ratione ut voluptatem eius ipsa accusamus. Minima rem dolorum vitae doloribus deserunt sequi fugit necessitatibus!</div>
          <div class="flex gap-6 justify-center">
            <a href="#" class="text-skin-inverted bg-skin-button-accent hover:bg-opacity-70 shadow-sm flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md sm:px-8"> Get started </a>
        ...
        <div class="dark relative bg-skin-fill max-w-4xl mx-auto overflow-hidden sm:rounded-2xl">
          ...
          <div class="relative max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div class="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                <a href="#" class="text-skin-muted bg-skin-button-accent hover:bg-opacity-70 shadow-sm flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md sm:px-8"> Get started </a>
                <a href="#" class="text-skin-base bg-skin-button-muted flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm bg-opacity-60 hover:bg-opacity-70 sm:px-8"> Live demo </a>
              </div>
            </div>
          </div>
        </div>
        <div class="light relative bg-skin-on-fill max-w-4xl mx-auto overflow-hidden sm:rounded-2xl">
          ...
          <div class="relative max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div class="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                <a href="#" class="text-skin-inverted bg-skin-button-accent hover:bg-opacity-75 flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm sm:px-8"> Get started </a>
                <a href="#" class="text-skin-base bg-skin-button-muted flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm bg-opacity-60 hover:bg-opacity-70 sm:px-8"> Live demo </a>
              </div>
            </div>
          </div>
